...
def symlink_unisolated_packages(env: IsolatedEnv) -> None:
    ...
    sysconfigdata_name = get_make_flag("SYSCONFIG_NAME")
    sysconfigdata_path = (
...
def get_build_env(
    ...
    *,
    ...
    with TemporaryDirectory() as symlink_dir_str:
        ...
        sysconfig_dir = Path(get_make_flag("TARGETINSTALLDIR")) / "sysconfigdata"
        args["PYTHONPATH"] = sys.path + [str(sysconfig_dir)]
        args["orig__name__"] = __name__
        args["pythoninclude"] = get_make_flag("PYTHONINCLUDE")
        args["PATH"] = env["PATH"]
        ...
        env["_PYTHON_SYSCONFIGDATA_NAME"] = get_make_flag("SYSCONFIG_NAME")

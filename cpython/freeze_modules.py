# Copied from https://github.com/python/cpython/blob/v3.11.1/Tools/scripts/freeze_modules.py
# Note: Don't forget to update this file when the Python version changes!
